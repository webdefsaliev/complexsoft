			...
			<section class="info">
				<div class="container">
					<div class="block">
						...
						<p>Автоматизация финансового учета - это не только снижение времени на обработку информации, но и возможность контроля за всеми процессами. <b>Money Manager</b> - универсальный помощник для малого бизнеса! </p>
						</div>
					</div>
				</div>
			</section>
