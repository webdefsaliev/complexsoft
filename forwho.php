    ...
    <div class="container">
        ...
        <div class="forwho-blocks">
            <div class="forwho-block wow bounceInLeft" data-wow-delay="0.6s">
                ...
                <div class="forwho-block__title">Новичкам:</div>
                <div class="forwho-block__subtitle">Ускоряет становление бизнеса, позволяет сэкономить на персонале, дает начальный толчок для развития. </div>
            </div>
            <div class="forwho-block wow bounceInLeft" data-wow-delay="0.8s">
                <div class="forwho-block__num"><img src="https://img.icons8.com/bubbles/150/000000/man-browser-window.png"></div>
                <div class="forwho-block__title">Действующий бизнес:</div>
                <div class="forwho-block__subtitle">Повышает эффективность работы, снижает издержки, оптимизирует производственные процессы. </div>
            </div>
            <!-- <div class="forwho-block">
                <div class="forwho-block__num"><img src="https://img.icons8.com/bubbles/90/000000/popular-man.png"></div>
                <div class="forwho-block__title">Компания на стадии банкротства:</div>
                <div class="forwho-block__subtitle">Выявляет слабые места, не надежных поставщиков, помогает найти пути избавления от проблем и принять правильные решения для спасения бизнеса. </div>
            </div>
            <div class="forwho-block">
                <div class="forwho-block__num"><img src="https://img.icons8.com/bubbles/90/000000/business-man-in-blue-jacket.png"></div>
