		...
		<div class="container">
			<div class="row">
				<div class="col-12 col-lg-8 align-self-center">
					<div class="main-block" id="slowly1">
						...
						<div class="main-block__info">
							<ul>
								...
								<li class="wow fadeInUp" data-wow-delay="0.2s" style="margin-top: -25px;"> <img src="https://img.icons8.com/color/175/000000/microsoft-excel-2019--v1.png">Функциональней Excel</li>
						...
						<!-- <a href="#offer-form-footer" class="main-block__btn">
							<button class="btn btn-o" onclick="gtag('event', 'proba', {'event_category': 'button'});"﻿ >Попробовать бесплатно</button>
						</a>
						<span style="display: block; font-size: 12px; color: #fff; margin-top: 7px;">*на 30дней</span> -->
					</div>
				</div>
